          ...
          {() => (
            <>
              <ModalHeader>
                ...
                <span className="heading">Eliminar Grupo</span>
              </ModalHeader>
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <div className="text-sm text-foreground/70">
                      Esta acción es irreversible. Se eliminará el grupo y sus
                      referencias en la aplicación local (si corresponde).
                    </div>
                  </div>
