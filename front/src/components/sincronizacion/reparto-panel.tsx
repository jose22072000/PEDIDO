import { Button, Card, CardBody, CardHeader, Chip, Snippet, Spinner, Switch, addToast } from "@heroui/react";
        ...
        <Card>
          ...
          <CardBody className="gap-4">
            ...
            <p className="text-[11px] text-default-400">
              Entra con la clave de servicio del reparto. Esta dirección no tiene
              interruptor: si la clave está mal, el reparto recibe un 401 y se ve en su
              propio registro.
            </p>
          </CardBody>
        </Card>
